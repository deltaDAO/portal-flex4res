...
export default function PageValueStreamMapping(): ReactElement {
  ...
  // finds out which account id is used autowallet or wagmi
  useEffect(() => {
    const finalAccountId = autoWallet?.address || accountId
    setFinalAccountId(finalAccountId)
  }, [accountId, autoWallet?.address])

  return (
    <ProfileProvider accountId={finalAccountId} ownAccount>
